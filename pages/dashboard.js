  ...
  return (
    <>
                ...
                <div className="tab-panel animate-in">
                  ...
                  <div className="att-mini-grid">
                    {attendance.slice(0, 6).map((a, i) => {
                      ...
                      return (
                        <div key={i} className="att-mini glass glass-hover animate-up" style={{ animationDelay: `${i * 50}ms` }}>
      ...
      <style jsx>{`
        ...
        .section-title { font-family: var(--font-display); font-size: 14.5px; font-weight: 700; color: var(--text-1); }
        ...
        .am-name { font-size: 12px; font-weight: 500; color: var(--text-1); line-height: 1.3; margin-bottom: 2px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
